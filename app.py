...
if data_file is not None:
	...
	# Add download button for pkl files
	st.write("To download the .pkl file, enter the desired filename and click below.")
	col1, col2 = st.columns([2, 1])

	with col1:
		pkl_filename = st.text_input('Enter output filename for .pkl (e.g. my-model.pkl)', 'clustered-data.pkl')

	with col2:
		st.write(" ")
		st.write(" ")
		st.write(" ")
		download_button_str_pkl = download_button(r[4], pkl_filename, 'Download .pkl', pickle_it=True)
		st.markdown(download_button_str_pkl, unsafe_allow_html=True)
